    ...
    <div className="fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r from-primary/90 via-primary to-primary/90 backdrop-blur-sm border-b border-primary-foreground/10">
      <div className="container py-2.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/"
            className="text-primary-foreground/80 hover:text-primary-foreground text-sm font-medium transition-colors hidden sm:inline"
          >
            ← Back to TrainU
          </Link>
          <Link
            to="/claim"
            className="inline-flex items-center gap-1.5 bg-background text-foreground px-4 py-1.5 rounded-lg font-semibold text-sm hover:bg-background/90 transition-colors"
          >
            Get My Free Site
